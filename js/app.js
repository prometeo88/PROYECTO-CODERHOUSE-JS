...
function cotizarSeguro() {
    ...
    if (autooMotoLower == "auto") {
        ...
        if (tercerosAutoLower == "a") {
            console.log("La responsabilidad Civil de un automóvil tiene un costo actual de $" + rcAuto)
            document.write("<br>","La responsabilidad Civil de un automóvil tiene un costo actual de $" + rcAuto)
        }
        else if (tercerosAutoLower == "b") {
            let sumaAsegurada = prompt("Ingrese el valor actual de mercado de su vehiculo")
            let costoAutoB = (rcAuto) + (sumaAsegurada * tasaAutoB)
            console.log("El costo de una cobertura B, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoAutoB.toFixed(2) + "mensual.")
            document.write("<br>","El costo de una cobertura B, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoAutoB.toFixed(2) + "mensual.")
        }
        else if (tercerosAutoLower == "c") {
            let sumaAsegurada = prompt("Ingrese el valor actual de mercado de su vehiculo")
            let costoAutoC = (rcAuto) + (sumaAsegurada * tasaAutoC)
            console.log("El costo de una cobertura C, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoAutoC.toFixed(2) + "mensual.")
            document.write("<br>","El costo de una cobertura C, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoAutoC.toFixed(2) + "mensual.")
        }
        else if (tercerosAutoLower == "cfull") {
            let sumaAsegurada = prompt("Ingrese el valor actual de mercado de su vehiculo")
            let costoAutoCFULL = (rcAuto) + (sumaAsegurada * tasaAutoCFULL)
            console.log("El costo de una cobertura CFull, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoAutoCFULL.toFixed(2) + "mensual.")
            document.write("<br>","El costo de una cobertura CFull, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoAutoCFULL.toFixed(2) + "mensual.")
        }
        else {
        ...
        if (tercerosMotoLower == "a") {
            console.log("La responsabilidad Civil de una moto tiene un costo actual de $" + rcMoto)
            document.write("<br>","La responsabilidad Civil de una moto tiene un costo actual de $" + rcMoto)
        }
        else if (tercerosMotoLower == "b") {
            let sumaAsegurada = prompt("Ingrese el valor actual de mercado de su vehiculo")
            let costoMotoB = (rcMoto) + (sumaAsegurada * tasaMotoB)
            console.log("El costo de una cobertura B, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoMotoB.toFixed(2) + "mensual.")
            document.write("<br>","El costo de una cobertura B, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoMotoB.toFixed(2) + "mensual.")
        }
        else if (tercerosMotoLower == "c") {
            let sumaAsegurada = prompt("Ingrese el valor actual de mercado de su vehiculo")
            let costoMotoC = (rcMoto) + (sumaAsegurada * tasaMotoC)
            console.log("El costo de una cobertura C, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoMotoC.toFixed(2) + "mensual.")
            document.write("<br>","El costo de una cobertura C, con una Suma Asegurada de $" + sumaAsegurada + " es de $" + costoMotoC.toFixed(2) + "mensual.")
        }
        else {
