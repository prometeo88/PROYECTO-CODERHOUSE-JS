...
function cotizarSeguro() {
    ...
    if (autooMotoLower == "auto") {
        ...
        if (tercerosAutoLower == "a") {
            console.log("La responsabilidad Civil de un automóvil tiene un costo actual de $" + respCivil[0].costo)
            document.write("<br>","La responsabilidad Civil de un automóvil tiene un costo actual de $" + respCivil[0].costo)
        }
        ...
        if (tercerosMotoLower == "a") {
            console.log("La responsabilidad Civil de una moto tiene un costo actual de $" + respCivil[1].costo)
            document.write("<br>","La responsabilidad Civil de una moto tiene un costo actual de $" + respCivil[1].costo)
        }
